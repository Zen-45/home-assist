...
Si l'emplacement du fichier de configuration des intégrations n'est pas /config/.storage/core.config_entries, adapter la ligne d'initialisation de la variable FIC_CONFIG.  
...
Il faut modifier les lignes :
 ...
 - 21 pour adapter l'heure de réveil par défaut
